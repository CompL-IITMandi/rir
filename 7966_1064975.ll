...
@copool_21 = private constant [3 x i32] [i32 0, i32 1, i32 2]
...
@copool_22 = private constant i32 3
...
@epe_7966_0_1064975 = available_externally externally_initialized global i8
@hast_7966 = available_externally externally_initialized global i8
@copool_23 = private constant %DeoptReason <{ i32 2, i32 353, i8* @hast_7966 }>
@epe_7966_1_1064975 = available_externally externally_initialized global i8
@copool_24 = private constant %DeoptReason <{ i32 6, i32 468, i8* @hast_7966 }>
...
@epe_7966_2_1064975 = available_externally externally_initialized global i8
@copool_25 = private constant %DeoptReason <{ i32 1, i32 537, i8* @hast_7966 }>
@epe_7966_3_1064975 = available_externally externally_initialized global i8
@copool_26 = private constant %DeoptReason <{ i32 6, i32 576, i8* @hast_7966 }>
@epe_7966_4_1064975 = available_externally externally_initialized global i8
@copool_27 = private constant %DeoptReason <{ i32 1, i32 645, i8* @hast_7966 }>

define %struct.SEXPREC* @f1_0_1F1E_10400F(i8* %code, %R_bcstack_t* %args, %struct.SEXPREC* %env, %struct.SEXPREC* %closure) {
...
BB14:                                             ; preds = %90
  ...
  call void @deopt(i8* %code, %struct.SEXPREC* %closure, i8* @epe_7966_0_1064975, %R_bcstack_t* %args, %DeoptReason* @copool_23, %struct.SEXPREC* %107)
...
BB16:                                             ; preds = %295
  ...
  call void @deopt(i8* %code, %struct.SEXPREC* %closure, i8* @epe_7966_1_1064975, %R_bcstack_t* %args, %DeoptReason* @copool_24, %struct.SEXPREC* %312)
...
BB18:                                             ; preds = %371
  ...
  call void @deopt(i8* %code, %struct.SEXPREC* %closure, i8* @epe_7966_2_1064975, %R_bcstack_t* %args, %DeoptReason* @copool_25, %struct.SEXPREC* %396)
...
BB20:                                             ; preds = %462
  ...
  call void @deopt(i8* %code, %struct.SEXPREC* %closure, i8* @epe_7966_3_1064975, %R_bcstack_t* %args, %DeoptReason* @copool_26, %struct.SEXPREC* %481)
...
BB22:                                             ; preds = %540
  ...
  call void @deopt(i8* %code, %struct.SEXPREC* %closure, i8* @epe_7966_4_1064975, %R_bcstack_t* %args, %DeoptReason* @copool_27, %struct.SEXPREC* %567)
...
581:                                              ; preds = %570, %BB21
  ...
  %590 = load i32, i32* @copool_22, align 4
